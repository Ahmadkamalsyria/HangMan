var riddles = [
  {
    riddle: ["The layer of the planet Earth where life exists"],
    answer: "BIOSPHERE"
  },
  {
    riddle: [
      "It occurs when carbon dioxide gas (or CO2) is absorbed by the ocean"
    ],
  ...
  {
    riddle: [
      "Sustainability framework where the design and production of materials,",
